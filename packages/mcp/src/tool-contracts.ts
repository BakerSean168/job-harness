...
export const CAREER_MCP_TOOLS = [
  ...
  tool({ name: 'career_application_record', description: 'Record that an application already occurred and append the initial timeline event; does not submit externally.', mutability: 'state-write', externalSideEffect: false, inputSchema: RecordApplicationInputSchema, outputSchema: RecordApplicationOutputSchema }),
