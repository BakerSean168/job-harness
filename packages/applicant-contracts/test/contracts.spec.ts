...
describe('ApplicantProfile stable autofill facts', () => {
  ...
  it('keeps new personal facts nullable for migrated profiles and validates explicit values', () => {
    ...
    expect(ApplicantProfileSchema.parse({ ...profile, gender:'male', birthDate:'2001-04-09', jobSearchStatus:'actively_looking', careerIdentity:'new_graduate' })).toMatchObject({ gender:'male', birthDate:'2001-04-09', jobSearchStatus:'actively_looking', careerIdentity:'new_graduate' });
