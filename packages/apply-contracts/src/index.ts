...
export const ApplyBundleSchema = z.object({
  ...
  applicantCatalogVersion: z.string().trim().min(1).max(200).nullable().default(null),
  answerSetVersion: z.string().trim().min(1).max(200).nullable().default(null),
  answerSetHash: z.string().trim().min(1).max(200).nullable().default(null),
