...
describe('ResumeEditor draft ownership', () => {
  it('keeps unsaved profile and library drafts when switching edit scope', () => {
    ...
    expect(screen.getByText(/站点简历基础资料待补全: 性别、出生日期/)).toBeTruthy();
