          ...
          {profile.education.map((education, index) => (
            <div className="applicant-education-card" key={education.id}>
              <div className="management-field-grid">
                ...
                <label className="management-field"><span>{copy.admissionType}</span><select value={education.admissionType ?? ''} onChange={(e) => setProfile({ ...profile, education: profile.education.map((item, i) => i === index ? { ...item, admissionType: e.target.value === 'unified' || e.target.value === 'non_unified' ? e.target.value : null } : item) })}><option value="">{copy.unknown}</option><option value="unified">{copy.admissionTypeUnified}</option><option value="non_unified">{copy.admissionTypeNonUnified}</option></select></label>
