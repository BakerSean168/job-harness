...
export const zhCN: MessageCatalog = {
  ...
  jobsWorkspace: {
    ...
    recommendation: { title: '简历匹配与投递准备', deterministic: '确定性评分', hint: '同时比较所有可用简历；准备投递时会发布/复用当前最新 Revision，并冻结精确 PDF Artifact。你也可以覆盖推荐结果。', recommended: '推荐', signals: '命中', risks: '风险', frozenReady: '已有冻结 PDF', freezeOnPrepare: '准备时冻结当前版', delta: '第一名领先第二名 {delta} 分。', prepare: '使用所选简历准备投递', decisions: { 'strong-match': '强匹配', review: '可投 / 建议复核', 'low-match': '低匹配' } },
    filters: {
