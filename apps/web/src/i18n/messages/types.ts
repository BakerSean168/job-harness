...
export interface MessageCatalog {
  ...
  settingsWorkspace: {
    ...
    characterization: { title: string; description: string; agent: string; targetUrl: string; targetHint: string; run: string; running: string; error: string; result: string; signals: string; actions: string; controls: string; formHash: string; noSignals: string; noActions: string; noControls: string; };
