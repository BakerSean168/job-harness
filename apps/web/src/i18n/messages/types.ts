...
export interface MessageCatalog {
  ...
  settingsWorkspace: {
    ...
    applicant: { profileTitle: string; profileDescription: string; name: string; phone: string; email: string; gender: string; genderMale: string; genderFemale: string; birthDate: string; location: string; jobSearchStatus: string; statusActivelyLooking: string; statusOpen: string; statusNotLooking: string; careerIdentity: string; careerIdentityStudent: string; careerIdentityNewGraduate: string; careerIdentityProfessional: string; unknown: string; github: string; website: string; targetRoles: string; targetCities: string; availableFrom: string; education: string; school: string; institutionTag: string; major: string; degree: string; admissionType: string; admissionTypeUnified: string; admissionTypeNonUnified: string; department: string; educationLocation: string; period: string; saveProfile: string; answersTitle: string; answersDescription: string; noAnswers: string; answerLabel: string; answerKey: string; answerType: string; sensitivity: string; answerValue: string; aliases: string; siteHost: string; addAnswer: string; removeAnswer: string; saveAnswers: string; sensitiveWarning: string; saving: string; saved: string; };
    applicantReference: { title: string; description: string; search: string; searchPlaceholder: string; copyValue: string; copyCategory: string; copyVisible: string; copied: string; empty: string; privacyNote: string; educationPrefix: string; siteScope: string; globalScope: string; categories: { profile: string; job: string; education: string; answers: string; }; fields: { name: string; phone: string; email: string; gender: string; birthDate: string; location: string; careerIdentity: string; jobSearchStatus: string; github: string; website: string; notes: string; targetRoles: string; targetCities: string; availableFrom: string; school: string; institutionTag: string; degree: string; major: string; admissionType: string; department: string; educationLocation: string; period: string; }; values: { male: string; female: string; student: string; newGraduate: string; professional: string; activelyLooking: string; open: string; notLooking: string; unified: string; nonUnified: string; }; };
    ...
    characterization: { title: string; description: string; agent: string; targetUrl: string; pendingBindings: string; pendingDescription: string; pendingNone: string; openTarget: string; expectedResume: string; targetHint: string; mode: string; isolatedMode: string; stagedMode: string; stagedHint: string; run: string; running: string; error: string; result: string; signals: string; actions: string; controls: string; formHash: string; noSignals: string; loginRequired: string; noActions: string; noControls: string; bindingTitle: string; bindingDescription: string; siteResumeLabel: string; profile: string; confirmBinding: string; bindingPending: string; bindingSuccess: string; bindingError: string; noBindingCandidates: string; existingBindings: string; noBindings: string; revoke: string; };
  ...
  executorsWorkspace: {
    ...
    dispatch: { title: string; empty: string; prepared: string; target: string; resume: string; created: string; safeFill: string; safeFillHint: string; missingExecutor: string; missingResume: string; missingTarget: string; alreadyDispatched: string; openJob: string; openAttempt: string; backend: string; backendSteel: string; backendExtension: string; };
    ...
    detail: { back: string; overview: string; review: string; authorizations: string; events: string; noReview: string; noAuthorization: string; reviewReady: string; reviewBlocked: string; authorize: string; resumeAuthorized: string; revoke: string; authorizationExpires: string; oneTimeWarning: string; formHash: string; reviewHash: string; fieldSummary: string; resumeEvidence: string; reconciliationTitle: string; reconciliationDescription: string; reconciliationBoundary: string; reconcileReadOnly: string; noResume: string; handoff: string; humanAction: string; humanActionDescription: string; waitingReason: string; continueAfterHuman: string; handoffExpired: string; };
  ...
  jobsWorkspace: {
    ...
    emailApplication: { back: string; title: string; description: string; recipient: string; subject: string; body: string; attachment: string; draftHash: string; intentState: string; providerBoundary: string; downloadResume: string; authorizeSend: string; authorized: string; workerNotConfigured: string; };
    filters: {
      title: string;
      company: string;
      city: string;
