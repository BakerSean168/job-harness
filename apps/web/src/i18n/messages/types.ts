...
export interface MessageCatalog {
  ...
  jobsWorkspace: {
    ...
    recommendation: { title: string; deterministic: string; hint: string; recommended: string; signals: string; risks: string; frozenReady: string; freezeOnPrepare: string; delta: string; prepare: string; decisions: Record<'strong-match' | 'review' | 'low-match', string>; };
    filters: {
      title: string;
      company: string;
      city: string;
