...
export const en: MessageCatalog = {
  ...
  executorsWorkspace: {
    ...
    dispatch: { title: 'Prepared safe fill', prepared: 'Prepared', empty: 'There is no prepared SubmissionIntent waiting for dispatch.', target: 'Target', resume: 'Resume evidence', created: 'Prepared at', safeFill: 'Start safe fill (no submit)', safeFillHint: 'This dispatches fill_only execution. A verified application-entry action and form filling may run, but final submit is never authorized. Login, OTP, security challenges, or ambiguous pages stop for human action.', missingExecutor: 'No compatible ready executor is available', missingResume: 'Bind an immutable Resume Revision and PDF Artifact first', missingTarget: 'No executable job URL is available', alreadyDispatched: 'This intent already has an active execution; continue it instead of dispatching a duplicate', openJob: 'Open job', openAttempt: 'Open active execution', backend: 'Execution browser', backendSteel: 'Cloud Steel browser', backendExtension: 'My Chrome (extension)' },
