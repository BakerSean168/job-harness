...
- [ ] **JH-R018:** converge the remaining recurring-automation central Job Ledger into Job Harness through a read-only, idempotent application-port importer; preserve 5 historical DiscoveryRuns / 21 Jobs and reconcile lossy company-only application evidence without inventing placeholder Applications.
