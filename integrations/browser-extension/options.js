...
const baseDriverCommands = ["session_acquire", "navigate", "current_url", "title", "body_text", "exists", "text", "value_matches", "fill", "select", "set_checked", "click", "wait", "scan_controls", "scan_actions", "form_state_hash"];
